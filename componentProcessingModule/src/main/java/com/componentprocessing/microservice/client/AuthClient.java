...
@FeignClient(name = "auth-client", url = "http://localhost:8009/authorization")
public interface AuthClient {
	 ...
	 @GetMapping(value = "/validate")
     public ValidatingDTO validatingAuthorizationToken(@RequestHeader(name = "Authorization", required = true) String token);

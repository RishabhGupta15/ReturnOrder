	...
	<header>
		<nav class="navbar navbar-expand-md navbar-light" >
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar" stlye="text-align:center">
					<ul class="navbar-nav ml-auto ms-0 me-0">
...
<div class="row">
			...
			<div class="col-md-4" id="login-form">
				<form action="cancel" method="Post" class="needs-validation"
					novalidate>
					...
					<div class="invalid-feedback">Please Enter Proper Credit
						Card Number.</div>
						<button type="submit" style="margin-bottom:25px;" class="btn btn-success btn-block"	>Cancel a Request</button>
